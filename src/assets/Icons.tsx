...
export const Logo = ({ className }: { className?: string }) => (
  <div className={className}>
    <img src="/logo.png" alt="Noorjahan Logo" className="w-full h-auto" />
  </div>
);

export const Face1 = ({ className }: { className?: string }) => (
...
export const Face2 = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="1">
...
export const Face3 = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="1">
    <rect x="25" y="25" width="50" height="50" rx="25" />
    <path d="M40 45 L60 45 M40 55 L60 55" />
  </svg>
);

export const Face4 = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="1">
